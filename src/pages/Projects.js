                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  {project.github && (
                    <a
                      ...
                      className="inline-flex items-center space-x-2 py-2 px-4 bg-cyan-500/10 text-cyan-500 rounded-lg hover:bg-cyan-500 hover:text-white transition-all duration-300 font-medium text-sm"
                    >
