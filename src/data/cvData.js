...
export const cvData = {
  ...
  projects: {
    en: [
      ...
      {
        id: 'seruca',
        name: 'SERUCA — Smart Event Recommendation',
        tech: ['Java', 'Spring Boot', 'TypeScript', 'PostgreSQL', 'Docker'],
        role: 'Full Stack Developer',
        description: 'AI-powered microservices platform for personalized university campus event recommendations',
    ...
    fr: [
      ...
      {
        id: 'seruca',
        name: 'SERUCA — Recommandation d\'Événements',
        tech: ['Java', 'Spring Boot', 'TypeScript', 'PostgreSQL', 'Docker'],
        role: 'Développeur Full Stack',
        description: 'Plateforme microservices IA pour des recommandations d\'événements campus personnalisées',
        github: 'https://gitlab.com/AkongaManuel/seruca',
      },
      {
        id: 'retailcloud',
