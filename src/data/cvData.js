...
export const cvData = {
  ...
  experience: {
    ...
    fr: [
      ...
      },
      {
        ...
        responsibilities: [
          'Maintenance préventive et curative du parc informatique et des systèmes informatiques',
          'Assistance aux utilisateurs et résolution d\'incidents de niveau 1 pour les problèmes matériels et logiciels',
          'Installation et configuration des systèmes d\'exploitation (Windows, Linux) et suites bureautiques',
          'Aide au déploiement et à la configuration des équipements réseaux de base et protocoles',
          'Dépannage réseau et résolution des problèmes de connectivité',
          ...
          'Formation des utilisateurs sur les opérations informatiques de base et l\'utilisation des logiciels',
          'Participation à la documentation des procédures techniques et création de base de connaissances',
  ...
  projects: {
    ...
    fr: [
      {
        id: 'real-estate',
        name: 'Système de Gestion Immobilière',
        tech: ['Angular', 'Java', 'Spring Boot', 'MySQL'],
        role: 'Développeur Full Stack',
        description: 'Plateforme complète de gestion immobilière avec interface dynamique et intégration de base de données',
      },
      {
        id: 'agricultural',
        name: 'Site Web de Gestion Agricole',
        tech: ['Angular', 'Java', 'Spring Boot'],
        role: 'Développeur Full Stack',
        description: 'Plateforme web pour le suivi des cultures et la gestion des ressources',
      },
      {
        id: 'hotel',
        ...
        tech: ['JavaScript', 'HTML5', 'CSS3'],
        role: 'Développeur Full Stack',
        description: 'Système complet de réservation et de gestion avec design responsive',
      },
      {
        id: 'immunization',
        ...
        tech: ['Angular', 'Java'],
        role: 'Développeur Full Stack',
        description: 'Suivi de la vaccination des patients avec intégration de calendrier',
      },
      {
        id: 'task-management',
        ...
        description: 'Application de productivité personnelle avec interface intuitive',
      },
    ],
  },
