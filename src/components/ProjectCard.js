  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-3">
        {project.isPrivate ? (
          <span className="flex-1 text-center py-2 px-4 bg-gray-500/10 text-gray-400 dark:text-gray-500 rounded-lg font-medium flex items-center justify-center space-x-2 cursor-default select-none">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <a
            ...
            className="flex-1 text-center py-2 px-4 bg-cyan-500/10 text-cyan-500 rounded-lg hover:bg-cyan-500 hover:text-white transition-all duration-300 font-medium flex items-center justify-center space-x-2"
          >
