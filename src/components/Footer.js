    ...
    <footer className="bg-gray-100 dark:bg-dark-800 border-t border-gray-200 dark:border-dark-700">
      <div className="container-custom px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-400">
              <li className="flex items-start space-x-2">
                ...
                <a href={`mailto:${personalInfo.email}`} className="hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors">
                  {personalInfo.email}
                </a>
              </li>
              <li className="flex items-start space-x-2">
                ...
                <a href={`tel:${personalInfo.phone}`} className="hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors">
                  {personalInfo.phone}
                </a>
              </li>
              <li className="flex items-start space-x-2">
        ...
        <div className="border-t border-gray-200 dark:border-dark-700 mt-8 pt-8 text-center text-gray-600 dark:text-gray-400">
          ...
          <p className="mt-2 text-sm">Built with React, TailwindCSS & Framer Motion</p>
        </div>
      </div>
    </footer>
  );
